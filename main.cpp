...
void test_base(int length,std::ofstream &f){
    ...
    for(int i = 0 ;i < length ;i++){
        kvStore.put(test_data[i], std::string(5000,'s'));
    }
...
int main() {
    std::ofstream f("../test_res/test_compaction.txt");
//    std::ofstream f("../test_res/test_base_big.txt");
//    std::vector<int> test_length_small{1000,1500,2000,2500,3000,3500,4000,4500,5000,5500,6000,6500,7000,7500,8000,8500,9000,9500,10000};
